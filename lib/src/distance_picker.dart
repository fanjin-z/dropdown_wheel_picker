...
/// Dropdown scrollable picker to select a distance in imperial or metric unit
class DropdownDistancePicker extends StatefulWidget {
  /// Creates a material design dropdown distance picker
